...
object AdvancedPatternMatching extends App {
  ...
  println(humanDescription)// same as Or(number, string) => ...
  ...
  object MyList {
    def unapplySeq[A](list: MyList[A]): Option[Seq[A]] = // must return Option with Sequence
  ...
  // two methods - isEmpty, get: something
